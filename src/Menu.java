...
public class Menu {
        ...
        while (!quitter) {
            ...
            switch (choix) {
                case "1":
                    ...
                    break;
                case "2":
                    creerPersonnage(scanner, chef, theatreActuel);
                    break;
                case "3":
    ...
    private static void creerPersonnage(Scanner scanner, ChefDeClan chef, Theatre theatreActuel) {
        ...
        chef.creerPersonnage(nomPerso, type, role, sexe, age);
    ...
    private static void transfererPersonnage(Scanner scanner, ChefDeClan chef) {
        ...
        System.out.println("\n Fonctionnalité de transfert en cours de développement.");
        System.out.println("Le personnage " + personnageATransferer.getNom() + " reste dans son lieu actuel.");
    }
