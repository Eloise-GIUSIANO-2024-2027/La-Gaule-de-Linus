...
public class Carte {
    ...
    public static Lieux getBeurk() { return Beurk; }
    public static Lieux getCielus() { return Cielus; }
    public static Lieux getBabaorum() { return Babaorum; }
    public static Lieux getAquarium() { return Aquarium; }
    public static Lieux getLaudanum() { return Laudanum; }
    public static Lieux getTiramisum() { return Tiramisum; }
    public static Lieux getHelium() { return Helium; }
        ...
        while(renseignement) {
            ...
            switch (choix) {
                ...
                case "2":
                    ...
                    break;
                default:
                    System.out.println("Choix non valide. Veuillez entrer un numéro soit 1 soit 2");
                    break;
            }
        }
    }
        ...
        while(renseignementLIEU) {
            ...
            switch (choix) {
                ...
                case "7":
                    ...
                    break;
                default:
                    System.out.println("Choix non valide. Veuillez entrer un numéro entre 1 et 7");
                    break;
            }
        }
    }
